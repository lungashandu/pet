...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet() {
        ...
        if (currentPetUri == null && TextUtils.isEmpty(nameString) &&
                TextUtils.isEmpty(breedString) && TextUtils.isEmpty(weightString) && mGender == PetEntry.GENDER_UNKNOWN) {
            return;
        }
        ...
        if (currentPetUri == null) {
            ...
            int numberOfUpdatedRows = getContentResolver().update(currentPetUri, values, null, null);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        // if this a new pet, hide the "Delete" menu item.
        if (currentPetUri == null) {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_delete:
                // Delete current pet from database
                deletePet();
                // exit activity
                finish();
                return true;
